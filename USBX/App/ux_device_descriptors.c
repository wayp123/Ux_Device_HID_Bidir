...
__ALIGN_BEGIN uint8_t USBD_HID_MOUSE_ReportDesc[USBD_HID_MOUSE_REPORT_DESC_SIZE] //pbw
__ALIGN_END =
{
		    ...
		    0x95, 0x02,                    //     REPORT_COUNT (2) //2bytes
		    0x81, 0x02,                    //     INPUT (Data,Var,Abs)
		    0xc0,                          //   END_COLLECTION
		    ...
		    0x29, 0x08,                    //   USAGE_MAXIMUM (Kana)
		    0x75, 0x08,                    //   REPORT_SIZE (8) //8 bits
		    0x95, 0x03,                    //   REPORT_COUNT (3) //3 bytes
                                      ...
                                      uint8_t *pCmpstConfDesc)
{
  ...
  switch (pdev->tclasslist[pdev->classId].ClassType)
  {
    ...
    case CLASS_TYPE_HID:
      ...
      pdev->tclasslist[pdev->classId].NumEps = 2U; /* EP1_IN  1U pbw*/
      ...
      if (pdev->Speed == USBD_HIGH_SPEED)
      {
        ...
        /* Assign out Endpoint PBW*/
        USBD_FrameWork_AssignEp(pdev, USBD_HID_EPOU_ADDR, USBD_EP_TYPE_INTR,
                                USBD_HID_EPIN_HS_MPS);
                                     ...
                                     uint32_t pConf, uint32_t *Sze)
{
  ...
  *Sze += (uint32_t)sizeof(USBD_HIDDescTypedef);
  ...
  if (pdev->Speed == USBD_HIGH_SPEED)
  {
    ...
    /* Append Endpoint descriptor to Configuration descriptor pbw */
